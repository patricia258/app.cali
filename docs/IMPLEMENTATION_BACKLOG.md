...
Escopo: cronograma em rascunho; revisão interna; envio ao cliente; aprovação/ajuste; ativação do projeto; deadlines; histórico; fluxo inspirado no Connect.

## Página 4 — Entregáveis / Kanban
Status: bloqueada.

Escopo: Kanban arrastável; estados completos; comentários; anexos; aprovação interna; aprovação do cliente; ajuste solicitado; histórico; imutabilidade após aprovação; NPS.

## Página 5 — Horas
Status: bloqueada.

Escopo: timer; lançamento manual; vínculo com cliente/projeto/entregável; consumo; alertas; histórico; exportação.

## Página 6 — Calendário
Status: bloqueada.

Escopo: calendário real em mês/semana/agenda; mini calendário; cores por evento; filtros; criação por dia; Google Calendar/Meet/Workspace via OAuth; notificações.

## Página 7 — Documentos
Status: bloqueada.

Escopo: biblioteca em cards com capa; links; versões; origem; categorias; comentários; Drive; cliente/projeto.

## Página 8 — Relatórios
Status: bloqueada.

Escopo: geração mensal; horas; entregáveis; NPS; interpretação executiva; PDF; e-mail; app; Drive; histórico de publicação/ciência.

## Página 9 — Experiência completa do Cliente
Status: bloqueada.
