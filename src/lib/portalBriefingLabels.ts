const fieldValues:Record<string,Record<string,string>>={
  ...
  mapa_status:{sim:'Sim, já respondeu',nao:'Ainda não',nao_sei:'Não tem certeza'},
  departamento_status:{nao_existe:'Ainda não existe uma área formal de RH',implantacao:'A área está sendo criada agora',basico:'Existe, mas está concentrada no básico e no operacional',parcial:'Já existem alguns processos ou subsistemas estruturados',estruturado:'O RH já é estruturado, mas uma ou mais frentes precisam ser construídas ou revistas'},
  lideranca_tecnica:{nao:'Não',outra_area:'Parcialmente, acumulada por outra área',interna:'Sim, dentro do RH',externa:'Sim, com apoio externo'},
  executor_interno:{sim:'Sim, já está definido',em_definicao:'Ainda estamos definindo',nao:'Não temos alguém disponível hoje'},
  escopo_build:{rh_completo:'Estruturar o RH como um todo',frente:'Construir ou revisar uma frente específica',varias:'Construir várias frentes relacionadas',nao_sei:'Ainda não sei — quero a recomendação da CALI'},
  frentes_build:{planejamento:'Planejamento estratégico de pessoas',desenho:'Estrutura, organograma e clareza de papéis',governanca:'Governança, políticas e processos',people_analytics:'Indicadores, People Analytics e dashboards',desempenho:'Gestão de desempenho e metas',clima:'Clima e engajamento',cultura:'Cultura, valores e rituais',cargos:'Cargos, carreira e remuneração',sucessao:'Sucessão e gestão de talentos',liderancas:'Desenvolvimento de lideranças',atracao:'Atração, seleção e onboarding',marca:'Marca empregadora e experiência do colaborador',comunicacao:'Comunicação interna',saude:'Saúde, riscos psicossociais e conformidade',relacoes:'Relações de trabalho e regras operacionais'},
  ponto_partida:{zero:'Praticamente do zero',rascunho:'Há ideias ou materiais soltos',parcial:'Já existe algo implantado, mas incompleto',revisao:'Existe um processo, mas precisa ser redesenhado'},
  urgencia:{sem_prazo:'Não há data crítica','30':'Em até 30 dias','60':'Entre 30 e 60 dias','90':'Entre 60 e 90 dias',mais90:'Acima de 90 dias'},
  capacidade_execucao:{baixa:'Baixa — a rotina atual já consome quase toda a capacidade',media:'Média — conseguimos reservar blocos de tempo por semana',alta:'Alta — existe capacidade protegida para o projeto'},
  horas_implantacao:{ate2:'Até 2 horas','3a5':'3 a 5 horas','6a10':'6 a 10 horas','10mais':'Mais de 10 horas'},
  autonomia_executor:{baixa:'Baixa — depende de aprovação para quase tudo',media:'Média — consegue conduzir parte das decisões',alta:'Alta — consegue tocar a implantação dentro das diretrizes aprovadas'},
  dependencias:{diretoria:'Diretoria',dp:'Departamento Pessoal',juridico:'Jurídico',contabilidade:'Contabilidade',sst:'Saúde e Segurança do Trabalho',ti:'Tecnologia / TI',marketing:'Marketing / Comunicação',financeiro:'Financeiro',outra:'Outra área'},
  sponsor_status:{aprovado:'A diretoria já aprovou a necessidade',apoia:'Apoia a ideia, mas ainda precisa aprovar escopo ou investimento',avaliando:'Está avaliando propostas antes de decidir',nao_claro:'Ainda não há patrocínio claro'},
  orcamento_status:{conhece:'Sim, conhece o teto mensal',nao_compartilhado:'Existe orçamento, mas não foi compartilhado',propostas:'A diretoria quer avaliar propostas primeiro',nao_definido:'Ainda não existe orçamento definido'},
  senioridade:{estagio_assistencia:'Estágio / Assistência',junior:'Júnior',pleno:'Pleno',senior:'Sênior',especialista:'Especialista',coordenacao:'Coordenação',gerencia:'Gerência',direcao:'Direção'},
