...
import { AdminReportsPageV4 } from './pages/admin/AdminReportsPageV4';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV4 /></ProtectedRoute>} />
