...
import { AdminReportsPageV7 } from './pages/admin/AdminReportsPageV7';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV7 /></ProtectedRoute>} />
