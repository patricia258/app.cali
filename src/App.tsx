...
import { AdminReportsPageV3 } from './pages/admin/AdminReportsPageV3';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV3 /></ProtectedRoute>} />
