...
import { AdminReportsPageV6 } from './pages/admin/AdminReportsPageV6';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV6 /></ProtectedRoute>} />
