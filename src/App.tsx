...
import { AdminReportsPageV9 } from './pages/admin/AdminReportsPageV9';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV9 /></ProtectedRoute>} />
