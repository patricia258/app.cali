...
import { AdminReportsPageV8 } from './pages/admin/AdminReportsPageV8';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/relatorios" element={<ProtectedRoute role="admin"><AdminReportsPageV8 /></ProtectedRoute>} />
